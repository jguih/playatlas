...
export type IGameSessionReadonlyStore = {
...
export class GameSessionReadonlyStore
	...
	implements IGameSessionReadonlyStore
{
	...
	getAllAsync: IGameSessionReadonlyStore["getAllAsync"] = async () => {
	...
	getByGameIdAsync: IGameSessionReadonlyStore["getByGameIdAsync"] = () => {

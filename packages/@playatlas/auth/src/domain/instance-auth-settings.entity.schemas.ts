...
export const buildInstanceAuthSettingsPropsSchema = makeInstanceAuthSettingsPropsSchema.extend(
	instanceAuthSettingsExtraPropsSchema.partial().shape,
);

export const rehydrateInstanceAuthSettingsPropsSchema = makeInstanceAuthSettingsPropsSchema.extend(

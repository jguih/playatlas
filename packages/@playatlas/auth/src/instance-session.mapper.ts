...
import { rehydrateInstanceSession, type InstanceSession } from "./domain/instance-session.entity";
import type { InstanceSessionModel } from "./infra/instance-session.repository";

export const instanceSessionMapper: EntityMapper<InstanceSession, InstanceSessionModel> = {
	toDomain: (model) => {

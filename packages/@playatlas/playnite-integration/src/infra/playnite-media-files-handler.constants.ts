 ...
 */
export const MEDIA_PRESETS: Record<ValidMediaFileFieldName, { w: number; h: number; q: number }> = {
	background: { w: 1920, h: 1080, q: 80 },
	cover: { w: 600, h: 900, q: 82 },
	icon: { w: 256, h: 256, q: 90 },
} as const;

export const isValidFileName = (value?: string): value is ValidMediaFileFieldName => {

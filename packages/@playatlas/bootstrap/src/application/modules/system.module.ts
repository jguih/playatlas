import { type EnvServiceDeps, makeEnvService, makeSystemConfig } from "@playatlas/system/infra";
import { type ISystemModulePort } from "./system.module.port";

export type SystemModuleDeps = EnvServiceDeps;

export const makeSystemModule = ({ env }: SystemModuleDeps): ISystemModulePort => {

...
export const SCORE_ENGINE_CORE_LEXICON_PT = {
	...
	SER_ESTAR: alternatives(l("e"), l("sao")),
	...
	CRIAR_GERAR: alternatives(plural(l("gerad(?:o|a)"), l("criad(?:o|a)"))),
	MORRER_FALHAR: alternatives(l("falh(?:e|ar|ou|ando)"), l("morr(?:e|er|eu|endo|ia|a)")),

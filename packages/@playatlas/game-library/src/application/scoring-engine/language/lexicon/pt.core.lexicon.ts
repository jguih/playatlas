...
export const SCORE_ENGINE_CORE_LEXICON_PT = {
	...
	IGUAL: alternatives(
		l("igua(?:l|is)"),
		l("igua(?:l|is)\\s+(?:a|ao)\\s+outr(?:a|o)"),
		l("igua(?:l|is)\\s+(?:a|ao)"),
	),
	UNICO: alternatives(plural(l("unic(?:a|o)"))),
	...
	POSSIBILIDADE: plural(l("possibilidade")),
	ILIMITADO: plural(l("ilimitad(?:a|o)"), l("infinit(?:o|a)")),
	SEM_LIMITE: plural(l("sem\\s+limite")),
	MANEIRA_FORMA: alternatives(plural(l("maneira"), l("forma"), l("jeito"))),
	COMBINAR: alternatives(l("combinar"), l("misturar"), l("mesclar"), l("unir"), l("montar")),
	SINERGIA: l("sinergi(?:a|as)"),
	ESTILO_DE_JOGO: alternatives(
		l("estil(?:o|os)\\s+de\\s+jogo"),
		l("estil(?:o|os)\\s+de\\s+gameplay"),
	),
	ESTRATEGIA: plural(l("estrategia")),
	DIFERENTE_DISTINTO: plural(l("diferente"), l("distint(?:a|o)")),
	VARIOS_NUMERICO: alternatives(
		l("dezenas(\\s+de)?"),
		l("centenas(\\s+de)?"),
		l("milhares(\\s+de)?"),
	),

...
import type { PlayniteLibraryService, PlayniteLibraryServiceDeps } from "./service.types";
...
export const makePlayniteLibraryService = ({
	...
	const getLibraryMetrics: PlayniteLibraryService["getLibraryMetrics"] = () => {
		...
		const gamesOwned = playniteLibraryMetricsRepository.getGamesOwnedLastNMonths(6);

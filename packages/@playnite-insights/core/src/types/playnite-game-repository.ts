...
export type PlayniteGameRepository = {
	...
	updateManyGenres: (gameGenresMap: Map<PlayniteGame["Id"], Genre["Id"][]>) => void;
	updateManyDevelopers: (gameDevelopersMap: Map<PlayniteGame["Id"], Company["Id"][]>) => void;
	updateManyPublishers: (gamePublishersMap: Map<PlayniteGame["Id"], Company["Id"][]>) => void;
	updateManyPlatforms: (gamePlatformsMap: Map<PlayniteGame["Id"], Platform["Id"][]>) => void;

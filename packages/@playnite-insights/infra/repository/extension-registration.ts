...
export const makeExtensionRegistrationRepository = (
	...
	const getByExtensionId: ExtensionRegistrationRepository["getByExtensionId"] = (extensionId) => {
		...
		return repositoryCall(
			...
			() => {
				...
				const extensionRegistration = z.optional(extensionRegistrationSchema).parse(result);
	...
	const getByRegistrationId: ExtensionRegistrationRepository["getByRegistrationId"] = (id) => {
	...
	const all: ExtensionRegistrationRepository["all"] = () => {
		return repositoryCall(
			...
			() => {
				...
				const registrations = z.array(extensionRegistrationSchema).parse(result);

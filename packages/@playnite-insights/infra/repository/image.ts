...
export const makeImageRepository = (deps: Partial<BaseRepositoryDeps> = {}): ImageRepository => {
...
export const defaultImageRepository: ImageRepository = makeImageRepository();

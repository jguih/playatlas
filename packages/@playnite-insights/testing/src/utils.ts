 ...
 */
const makeRequestEventCookies = (initial: Record<string, string> = {}): Cookies => {
...
const registerInstanceAndCreateSessionAsync = async (services: ServerServices): Promise<string> => {
